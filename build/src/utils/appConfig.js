...
class DevAppconfig extends BaseAppConfig {
    constructor() {
        super(...arguments);
        this.port = 4000;
        this.dbConfig = Object.assign(Object.assign({}, this.dbConfig), { host: 'localhost', port: 3306, database: 'store' });
    }
}
class ProdAppconfig extends BaseAppConfig {
    constructor() {
        super(...arguments);
        this.port = 443;
        this.dbConfig = Object.assign(Object.assign({}, this.dbConfig), { host: 'aws://db:/localZone-use123123', port: 3309, database: 'store_prod' });
    }
}
